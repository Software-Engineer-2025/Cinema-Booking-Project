...
INSERT INTO user (user_id, first_name, last_name, is_admin, promotional_list) VALUES
...
SELECT setval(pg_get_serial_sequence('user', 'user_id'), (SELECT COALESCE(MAX(user_id), 0) FROM user), true);
