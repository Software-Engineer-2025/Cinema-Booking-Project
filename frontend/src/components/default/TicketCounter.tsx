...
export default function TicketCounter({
  ...
  return (
    <div
      className={`flex flex-row rounded-md bg-white/10 items-center justify-between py-3 px-4 sm:px-7 ${className}`}
    >
      {/* Label + Price grouped together */}
      <div className="flex items-center gap-2 sm:gap-4">
        <span className="font-body font-bold text-base sm:text-lg">
          {label}
        </span>
      ...
      <div className="flex items-center gap-3 sm:gap-4">
        ...
        <span className="min-w-[20px] text-center font-bold text-base sm:text-lg">
          {count}
        </span>
        <button
          onClick={increment}
