...
def create_showroom(showroom: ShowroomCreate):
    ...
    response = supabase.table("showroom").insert(showroom.model_dump()).select().single().execute()
    return response
...
def get_all_showrooms() -> List[dict]:
    ...
    response = supabase.table("showroom").select("*").execute()
...
def get_showroom_by_id(showroom_id: int) -> Optional[dict]:
    ...
    try:
        response = supabase.table("showroom").select("*").eq("showroom_id", showroom_id).single().execute()
        return response.data
...
def update_showroom(showroom_id: int, showroom_data: ShowroomCreate):
    ...
    response = supabase.table("showroom").update(showroom_data.model_dump()).eq("showroom_id", showroom_id).execute()
    return response
...
def delete_showroom(showroom_id: int):
    ...
    response = supabase.table("showroom").delete().eq("showroom_id", showroom_id).execute()
    return response
